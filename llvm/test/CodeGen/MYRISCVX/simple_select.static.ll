...
define dso_local signext i32 @simple_select_exp(i32 signext %op1, i32 signext %a, i32 signext %b) #0 {

; MYRVX32I_STATIC_MEDLOW-LABEL: simple_select_exp:
...
; MYRVX32I_STATIC_MEDLOW-NEXT: 	beq	x10, x0, $BB0_2
...
; MYRVX64I_STATIC_MEDLOW-LABEL: simple_select_exp:
...
; MYRVX64I_STATIC_MEDLOW-NEXT: 	beq	x10, x0, $BB0_2
