...
; MYRVX32I_STATIC_MEDANY-NEXT:	addi	x11, x0, 0
...
; MYRVX32I_STATIC_MEDANY-NEXT:	addi	x9, x11, 0
; MYRVX32I_STATIC_MEDANY-NEXT:	call	func_S32
; MYRVX32I_STATIC_MEDANY-NEXT:	addi	x12, x10, 0
...
; MYRVX32I_STATIC_MEDANY-NEXT:	addi	x13, x0, 0
; MYRVX32I_STATIC_MEDANY-NEXT:	addi	x14, x12, 0
; MYRVX32I_STATIC_MEDANY-NEXT:	bne	x15, x13, $BB1_2
; MYRVX32I_STATIC_MEDANY-NEXT:# %bb.1:                                # %entry
; MYRVX32I_STATIC_MEDANY-NEXT:	addi	x14, x13, 0
...
; MYRVX32I_STATIC_MEDANY-NEXT:	addi	x12, x14, 0
...
; MYRVX32I_STATIC_MEDANY-NEXT:	sw	x2, 8(x2)               # 4-byte Folded Spill
; MYRVX32I_STATIC_MEDANY-NEXT:	sw	x9, 4(x2)               # 4-byte Folded Spill
; MYRVX32I_STATIC_MEDANY-NEXT:	addi	x9, x10, 0
...
; MYRVX32I_STATIC_MEDANY-NEXT:	addi	x14, x0, 0
; MYRVX32I_STATIC_MEDANY-NEXT:	addi	x15, x13, 0
; MYRVX32I_STATIC_MEDANY-NEXT:	bne	x16, x14, $BB2_2
; MYRVX32I_STATIC_MEDANY-NEXT:# %bb.1:                                # %entry
; MYRVX32I_STATIC_MEDANY-NEXT:	addi	x15, x14, 0
...
; MYRVX32I_STATIC_MEDANY-NEXT:# %bb.3:                                # %entry
; MYRVX32I_STATIC_MEDANY-NEXT:	addi	x13, x15, 0
...
; MYRVX32I_STATIC_MEDANY-NEXT:	addi	x9, x10, 0
; MYRVX32I_STATIC_MEDANY-NEXT:	addi	x10, x2, 0
...
; MYRVX32I_STATIC_MEDANY-NEXT:	addi	x29, x13, 0
; MYRVX32I_STATIC_MEDANY-NEXT:	bne	x30, x14, $BB3_2
; MYRVX32I_STATIC_MEDANY-NEXT:# %bb.1:                                # %entry
; MYRVX32I_STATIC_MEDANY-NEXT:	addi	x29, x14, 0
...
; MYRVX32I_STATIC_MEDANY-NEXT:# %bb.3:                                # %entry
; MYRVX32I_STATIC_MEDANY-NEXT:	addi	x15, x29, 0
...
; MYRVX32I_STATIC_MEDANY-NEXT:	addi	x12, x13, 0
...
; MYRVX32I_STATIC_MEDANY-NEXT:	addi	x13, x12, 0
